    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Crear Nuevo Campo Personalizado</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.custom-fields.store') }}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('field_type') is-invalid @enderror" 
                                    ...
                                    <option value="text" {{ old('field_type') == 'text' ? 'selected' : '' }}>Texto</option>
                                    <option value="number" {{ old('field_type') == 'number' ? 'selected' : '' }}>Número</option>
                                    <option value="email" {{ old('field_type') == 'email' ? 'selected' : '' }}>Email</option>
                                    <option value="tel" {{ old('field_type') == 'tel' ? 'selected' : '' }}>Teléfono</option>
                                    <option value="select" {{ old('field_type') == 'select' ? 'selected' : '' }}>Lista Desplegable</option>
                                    ...
                                    <option value="textarea" {{ old('field_type') == 'textarea' ? 'selected' : '' }}>Área de Texto</option>
                                    <option value="file" {{ old('field_type') == 'file' ? 'selected' : '' }}>Archivo</option>
                                    <option value="date" {{ old('field_type') == 'date' ? 'selected' : '' }}>Fecha</option>
                                    <option value="time" {{ old('field_type') == 'time' ? 'selected' : '' }}>Hora</option>
                                    <option value="datetime" {{ old('field_type') == 'datetime' ? 'selected' : '' }}>Fecha y Hora</option>
                                </select>
                                @error('field_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle me-2"></i>Crear Campo
                        </button>
                    </div>
                </form>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div id="field-preview">
                    <p class="text-muted">Selecciona un tipo de campo para ver la vista previa</p>
                </div>
            </div>
        </div>
    </div>
